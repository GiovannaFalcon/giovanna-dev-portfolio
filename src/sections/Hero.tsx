    ...
    >
      <div className="absolute inset-0 pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={430} rotation={-14} shouldOrbit orbitDuration="30s">
          <SparkleIcon className="size-8 text-[#8F5AF5]" />
        </HeroOrbit>

        <HeroOrbit size={440} rotation={79} shouldOrbit orbitDuration="32s">
          <SparkleIcon className="size-5 text-[#C5AEF1]" />
        </HeroOrbit>

        <HeroOrbit size={520} rotation={-41} shouldOrbit orbitDuration="34s">
          <div className="size-2 rounded-full bg-[#8F5AF5]" />
        </HeroOrbit>

        <HeroOrbit size={530} rotation={178} shouldOrbit orbitDuration="36s">
          <SparkleIcon className="size-10 text-[#8F5AF5]" />
        </HeroOrbit>

        <HeroOrbit size={550} rotation={20} shouldOrbit orbitDuration="38s">
          <StarIcon className="size-12 text-[#C5AEF1]" />
        </HeroOrbit>

        <HeroOrbit size={590} rotation={98} shouldOrbit orbitDuration="40s">
          <StarIcon className="size-8 text-[#C5AEF1]" />
        </HeroOrbit>

        <HeroOrbit size={650} rotation={-5} shouldOrbit orbitDuration="42s">
          <div className="size-2 rounded-full text-[#8F5AF5]" />
        </HeroOrbit>

        <HeroOrbit size={710} rotation={144} shouldOrbit orbitDuration="44s">
          <SparkleIcon className="size-14 text-[#8F5AF5]" />
        </HeroOrbit>

        <HeroOrbit size={720} rotation={85} shouldOrbit orbitDuration="46s">
          <div className="size-3 rounded-full bg-[#C5AEF1]" />
        </HeroOrbit>

        <HeroOrbit size={780} rotation={-72} shouldOrbit orbitDuration="48s">
          <StarIcon className="size-28 text-[#8F5AF5]" />
        </HeroOrbit>
      </div>
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif font-black text-3xl md:text-5xl text-center mt-8 tracking-wide text-white/90">
      ...
      <div className="flex flex-col md:flex-row justify-center z-10 items-center mt-8 gap-4">
        <a
          href="#projects"
          className="inline-flex items-center gap-2 border-[2px] border-white/15 px-6 h-12 rounded-xl"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 border border-white bg-[#EFEFEF] text-gray-900 h-12 px-6 rounded-xl"
          target="_blank"
